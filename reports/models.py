...
class Patient(models.Model):
    ...
    pa_cell_phone_add1 = models.CharField(max_length=50, blank=True, default='', null=True)
    pa_cell_phone_add2 = models.CharField(max_length=50, blank=True, default='', null=True)
